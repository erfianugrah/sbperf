...
${drill("tables", "Biggest tables", "by total relation size (heap + indexes + TOAST)", sec(a.sql.biggestTables, "sql:biggestTables", { mono: ["table"], hide: ["schema", "total_bytes", "index_bytes"], limit: 20 }))}
